...
export const normalizePanchanga = (values: DailyPanchangaInput): DailyPanchangaInput => ({
  ...
  display_date: optional(values.display_date),
...
export const PanchangaCreate = () => {
  const form = useForm<BaseRecord, HttpError, DailyPanchangaInput>({
    defaultValues: { language: "kn", panchanga_date: "", samvatsara: "", ayana: "", rutu: "", masa: "", paksha: "", tithi: "", vasara: "", weekday: "", nakshatra: "", yoga: "", karana: "", approve_status: false },
  });
